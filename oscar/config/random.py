...
mod_LSNKcover = choice([
        "ESA-CCI", "MODIS", "Ramankutty1999", "Levavasseur2012", "CLM-45", "JSBACH", "JULES", "LPJ", "LPJ-GUESS", "LPX-Bern", "OCN", "ORCHIDEE", "VISIT", ])
...
# Hydroxyl
mod_OHSNKtau = choice([
        "Prather2012", "CESM-CAM-superfast", "CICERO-OsloCTM2", "CMAM", "EMAC", "GEOSCCM", "GDFL-AM3", "GISS-E2-R", "GISS-E2-R-TOMAS", "HadGEM2", "LMDzORINCA", "MIROC-CHEM", "MOCAGE", "NCAR-CAM-35", "STOC-HadAM3", "TM5", "UM-CAM", ])
...
mod_O3Tregsat = choice([
        "", "CAMCHEM", "FRSGCUCI", "GISS-modelE", "GMI", "INCA", "LLNL-IMPACT", "MOZART-GFDL", "MOZECH", "STOC-HadAM3", "TM5-JRC", "UM-CAM", ])
mod_O3Temis = choice(["mean-OxComp", "CICERO-OsloCTM2", "NCAR-CAM-35", "STOC-HadAM3", "UM-CAM"])
mod_O3Tclim = choice(["", "CESM-CAM-superfast", "GFDL-AM3", "GISS-E2-R", "MIROC-CHEM", "MOCAGE", "NCAR-CAM-35", "STOC-HadAM3", "UM-CAM"])
mod_O3Tradeff = choice([
        "IPCC-AR5", "IPCC-AR4", "CESM-CAM-superfast", "CICERO-OsloCTM2", "CMAM", "EMAC", "GEOSCCM", "GFDL-AM3", "GISS-E2-R", "GISS-E2-R-TOMAS", "HadGEM2", "LMDzORINCA", "MIROC-CHEM", "MOCAGE", "NCAR-CAM-35", "STOC-HadAM3", "UM-CAM", "TM5", ])

# Ozone strato
mod_O3Sfracrel = choice(["Newman2006", "Laube2013"])
mod_O3Strans = choice([
        "AMTRAC", "CCSR-NIES", "CMAM", "CNRM-ACM", "LMDZrepro", "MRI", "Niwa-SOCOL", "SOCOL", "ULAQ", "UMSLIMCAT", "UMUKCA-UCAM", ])
...
mod_SO4radeff = choice([
        "BCC", "CAM4-Oslo", "CAM-51", "GEOS-CHEM", "GISS-MATRIX", "GISS-modelE", "GMI", "GOCART", "HadGEM2", "IMPACT-Umich", "INCA", "MPIHAM", "NCAR-CAM-35", "OsloCTM2", "SPRINTARS", ])
...
mod_NO3radeff = choice(["GEOS-CHEM", "GISS-MATRIX", "GMI", "HadGEM2", "IMPACT-Umich", "INCA", "NCAR-CAM-35", "OsloCTM2"])
...
mod_CLOUDerf = choice(["mean-ACCMIP", "CSIRO-Mk360", "GFDL-AM3", "GISS-E2-R", "HadGEM2", "LMDzORINCA", "MIROC-CHEM", "NCAR-CAM-51"])
mod_CLOUDpreind = choice(["low", "median", "high"])

# Albedo bc
mod_ALBBCreg = choice(["Reddy2007"])
mod_ALBBCrf = choice([
        "CICERO-OsloCTM2", "GFDL-AM3", "GISS-E2-R", "GISS-E2-R-TOMAS", "HadGEM2", "MIROC-CHEM", "NCAR-CAM-35", "NCAR-CAM-51", ])
...
# Temperature
mod_TEMPresp = choice([
        "ACCESS-10", "ACCESS-13", "BCC-CSM-11", "BCC-CSM-11m", "CanESM2", "CCSM4", "CNRM-CM5", "CNRM-CM5-2", "CSIRO-Mk360", "GFDL-CM3", "GFDL-ESM2G", "GFDL-ESM2M", "GISS-E2-H", "GISS-E2-R", "HadGEM2-ES", "IPSL-CM5A-LR", "IPSL-CM5A-MR", "IPSL-CM5B-LR", "MIROC5", "MIROC-ESM", "MPI-ESM-LR", "MPI-ESM-MR", "MPI-ESM-P", "MRI-CGCM3", "NorESM1-M", ])
