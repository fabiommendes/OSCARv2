...
mod_LSNKpreind = choice(
    ['CLM-45', 'JSBACH', 'JULES', 'LPJ', 'LPJ-GUESS', 'LPX-Bern', 'OCN', 'ORCHIDEE',
     'VISIT'])
mod_LSNKtrans = choice(
    ['BCC-CSM-11', 'CESM1-BGC', 'CanESM2', 'HadGEM2-ES', 'IPSL-CM5A-LR', 'MPI-ESM-LR',
     'NorESM1-ME'])
mod_LSNKcover = choice(
    ['ESA-CCI', 'MODIS', 'Ramankutty1999', 'Levavasseur2012', 'CLM-45', 'JSBACH', 'JULES',
     'LPJ', 'LPJ-GUESS', 'LPX-Bern', 'OCN', 'ORCHIDEE', 'VISIT'])

# Wildfires
mod_EFIREpreind = choice(
    ['', 'CLM-45', 'JSBACH', 'LPJ', 'LPJ-GUESS', 'ORCHIDEE', 'VISIT'])
...
mod_OHSNKtrans = choice(
    ['mean-OxComp', 'Holmes2013', 'GEOS-Chem', 'Oslo-CTM3', 'UCI-CTM'])

# Wetlands
mod_EWETpreind = choice(
    ['', 'CLM-4Me', 'DLEM', 'IAP-RAS', 'LPJ-Bern', 'LPJ-WSL', 'ORCHIDEE', 'SDGVM'])
mod_AWETtrans = choice(
    ['', 'CLM-4Me', 'DLEM', 'LPJ-Bern', 'ORCHIDEE', 'SDGVM', 'UVic-ESCM'])

# Photolysis
mod_HVSNKtau = choice(
    ['Prather2015', 'GMI', 'GEOSCCM', 'G2d-M', 'G2d', 'Oslo-c29', 'Oslo-c36', 'UCI-c29',
     'UCI-c36'])
...
mod_O3Tregsat = choice(
    ['', 'CAMCHEM', 'FRSGCUCI', 'GISS-modelE', 'GMI', 'INCA', 'LLNL-IMPACT',
     'MOZART-GFDL', 'MOZECH', 'STOC-HadAM3', 'TM5-JRC', 'UM-CAM'])
mod_O3Temis = choice(
    ['mean-OxComp', 'CICERO-OsloCTM2', 'NCAR-CAM-35', 'STOC-HadAM3', 'UM-CAM'])
mod_O3Tclim = choice(
    ['', 'CESM-CAM-superfast', 'GFDL-AM3', 'GISS-E2-R', 'MIROC-CHEM', 'MOCAGE',
     'NCAR-CAM-35', 'STOC-HadAM3', 'UM-CAM'])
mod_O3Tradeff = choice(
    ['IPCC-AR5', 'IPCC-AR4', 'CESM-CAM-superfast', 'CICERO-OsloCTM2', 'CMAM', 'EMAC',
     'GEOSCCM', 'GFDL-AM3', 'GISS-E2-R', 'GISS-E2-R-TOMAS', 'HadGEM2', 'LMDzORINCA',
     'MIROC-CHEM', 'MOCAGE', 'NCAR-CAM-35', 'STOC-HadAM3', 'UM-CAM', 'TM5'])

# Ozone strato
mod_O3Sfracrel = choice(['Newman2006', 'Laube2013'])
mod_O3Strans = choice(
    ['AMTRAC', 'CCSR-NIES', 'CMAM', 'CNRM-ACM', 'LMDZrepro', 'MRI', 'Niwa-SOCOL', 'SOCOL',
     'ULAQ', 'UMSLIMCAT', 'UMUKCA-UCAM'])
mod_O3Snitrous = choice(['', 'Daniel2010'])
mod_O3Sradeff = choice(['IPCC-AR4', 'ULAQ', 'DLR-E39C', 'NCAR-MACCM', 'CHASER'])

# Sulfate
mod_SO4regsat = choice(
    ['', 'CAMCHEM', 'GISS-PUCCINI', 'GMI', 'GOCART', 'INCA2', 'LLNL-IMPACT', 'SPRINTARS'])
mod_SO4load = choice(['CSIRO-Mk360', 'GFDL-AM3', 'GISS-E2-R', 'MIROC-CHEM'])
mod_SO4radeff = choice(
    ['BCC', 'CAM4-Oslo', 'CAM-51', 'GEOS-CHEM', 'GISS-MATRIX', 'GISS-modelE', 'GMI',
     'GOCART', 'HadGEM2', 'IMPACT-Umich', 'INCA', 'MPIHAM', 'NCAR-CAM-35', 'OsloCTM2',
     'SPRINTARS'])

# POA
mod_POAconv = choice(['default', 'GFDL', 'CSIRO'])
mod_POAregsat = choice(
    ['', 'CAMCHEM', 'GISS-PUCCINI', 'GMI', 'GOCART', 'INCA2', 'LLNL-IMPACT', 'SPRINTARS'])
...
mod_NO3radeff = choice(
    ['GEOS-CHEM', 'GISS-MATRIX', 'GMI', 'HadGEM2', 'IMPACT-Umich', 'INCA', 'NCAR-CAM-35',
     'OsloCTM2'])
...
mod_ALBBCrf = choice(
    ['CICERO-OsloCTM2', 'GFDL-AM3', 'GISS-E2-R', 'GISS-E2-R-TOMAS', 'HadGEM2',
     'MIROC-CHEM', 'NCAR-CAM-35', 'NCAR-CAM-51'])
...
# Temperature
mod_TEMPresp = choice(
    ['ACCESS-10', 'ACCESS-13', 'BCC-CSM-11', 'BCC-CSM-11m', 'CanESM2', 'CCSM4',
     'CNRM-CM5', 'CNRM-CM5-2', 'CSIRO-Mk360', 'GFDL-CM3', 'GFDL-ESM2G', 'GFDL-ESM2M',
