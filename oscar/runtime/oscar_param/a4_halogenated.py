...
tau_PFC_OH = scale_OH * np.array(infs(10), dtype=dty)
tau_ODS_OH = scale_OH * np.array([*infs(6), 6.1, 12.8, 10.7, 19.3, *infs(4), 1.5, 1.9], dtype=dty)
...
tau_ODS_hv = 1.06 * np.array([45, 100, 85, 190, 1020, 35, 39, 186, 64.9, 160, *infs(6)], dtype=dty)

# other sinks lifetime {yr}
# idem
tau_HFC_othr = np.array(infs(11), dtype=dty)
tau_PFC_othr = np.array(infs(10), dtype=dty)
tau_ODS_othr = np.array([*infs(5), 101, 89, *infs(3), 16, 2.9, 65, 20, 3, 1.4], dtype=dty)
