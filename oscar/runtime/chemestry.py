...
from .oscar_param import f_kOH, f_hv, alpha_CH4, tau_CH4_OH, CH4_0, tau_CH4_hv, tau_CH4_soil, tau_CH4_ocean, alpha_N2O, tau_N2O_hv, N2O_0, alpha_HFC, tau_HFC_OH, alpha_PFC, tau_PFC_OH, alpha_ODS, tau_ODS_OH, tau_HFC_hv, \
...
from .util import mk_scalar_var, mk_species_var, mk_scalar
