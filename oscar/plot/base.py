...
def plot_CO2(D_CO2, OSNK, LSNK, ELUC, EFF, D_AREA, D_npp, D_efire, D_fmort, D_rh1, D_fmet, D_rh2, D_FIN, D_FOUT, D_FCIRC, D_MORT_luc, D_EFIRE_luc, D_RH1_luc, D_RH2_luc, EHWP1_luc, EHWP2_luc, EHWP3_luc,):
    ...
    if ind_final > ind_cdiac:
        plt.plot(1700 + np.arange(min(len(scenarios.CO2_rcp), ind_final + 1)), scenarios.CO2_rcp[: min(len(scenarios.CO2_rcp), ind_final + 1), 0] - historical.CO2_0, color="0.8", lw=2, ls=":", label="RCP2.6", )
        plt.plot(1700 + np.arange(min(len(scenarios.CO2_rcp), ind_final + 1)), scenarios.CO2_rcp[: min(len(scenarios.CO2_rcp), ind_final + 1), 1] - historical.CO2_0, color="0.6", lw=2, ls=":", label="RCP4.5", )
        plt.plot(1700 + np.arange(min(len(scenarios.CO2_rcp), ind_final + 1)), scenarios.CO2_rcp[: min(len(scenarios.CO2_rcp), ind_final + 1), 2] - historical.CO2_0, color="0.4", lw=2, ls=":", label="RCP6.0", )
        plt.plot(1700 + np.arange(min(len(scenarios.CO2_rcp), ind_final + 1)), scenarios.CO2_rcp[: min(len(scenarios.CO2_rcp), ind_final + 1), 3] - historical.CO2_0, color="0.2", lw=2, ls=":", label="RCP8.5", )
...
def plot_CH4(D_CH4, D_OHSNK_CH4, D_HVSNK_CH4, D_XSNK_CH4, D_EWET, D_EBB_CH4, ECH4):
    ...
    if ind_final > ind_cdiac:
        plt.plot(1700 + np.arange(min(len(scenarios.CH4_rcp), ind_final + 1)), scenarios.CH4_rcp[: min(len(scenarios.CH4_rcp), ind_final + 1), 0] - historical.CH4_0, color="0.8", lw=2, ls=":", label="RCP2.6", )
        plt.plot(1700 + np.arange(min(len(scenarios.CH4_rcp), ind_final + 1)), scenarios.CH4_rcp[: min(len(scenarios.CH4_rcp), ind_final + 1), 1] - historical.CH4_0, color="0.6", lw=2, ls=":", label="RCP4.5", )
        plt.plot(1700 + np.arange(min(len(scenarios.CH4_rcp), ind_final + 1)), scenarios.CH4_rcp[: min(len(scenarios.CH4_rcp), ind_final + 1), 2] - historical.CH4_0, color="0.4", lw=2, ls=":", label="RCP6.0", )
        plt.plot(1700 + np.arange(min(len(scenarios.CH4_rcp), ind_final + 1)), scenarios.CH4_rcp[: min(len(scenarios.CH4_rcp), ind_final + 1), 3] - historical.CH4_0, color="0.2", lw=2, ls=":", label="RCP8.5", )
    ...
    # lifetime
    ax = plt.subplot(2, 3, 3)
    plt.plot(1700 + np.arange(ind_final + 1), alpha_CH4
    ...
    plt.plot(1700 + np.arange(ind_final + 1), alpha_CH4 * (historical.CH4_0 + D_CH4) / (alpha_CH4 * historical.CH4_0 / tau_CH4_OH - D_OHSNK_CH4), color="k", lw=1, label="OH only", )
...
def plot_N2O(D_N2O, D_HVSNK_N2O, D_EBB_N2O, EN2O):
    ...
    if ind_final > ind_cdiac:
        plt.plot(1700 + np.arange(min(len(scenarios.N2O_rcp), ind_final + 1)), scenarios.N2O_rcp[: min(len(scenarios.N2O_rcp), ind_final + 1), 0] - historical.N2O_0, color="0.8", lw=2, ls=":", label="RCP2.6", )
        plt.plot(1700 + np.arange(min(len(scenarios.N2O_rcp), ind_final + 1)), scenarios.N2O_rcp[: min(len(scenarios.N2O_rcp), ind_final + 1), 1] - historical.N2O_0, color="0.6", lw=2, ls=":", label="RCP4.5", )
        plt.plot(1700 + np.arange(min(len(scenarios.N2O_rcp), ind_final + 1)), scenarios.N2O_rcp[: min(len(scenarios.N2O_rcp), ind_final + 1), 2] - historical.N2O_0, color="0.4", lw=2, ls=":", label="RCP6.0", )
        plt.plot(1700 + np.arange(min(len(scenarios.N2O_rcp), ind_final + 1)), scenarios.N2O_rcp[: min(len(scenarios.N2O_rcp), ind_final + 1), 3] - historical.N2O_0, color="0.2", lw=2, ls=":", label="RCP8.5", )
    ...
    # lifetime
    ax = plt.subplot(2, 3, 3)
    plt.plot(1700 + np.arange(ind_final + 1), alpha_N2O * (historical.N2O_0 + D_N2O) / (alpha_N2O * historical.N2O_0 / tau_N2O_hv - D_HVSNK_N2O), color="k", lw=2, label="OSCAR", )
