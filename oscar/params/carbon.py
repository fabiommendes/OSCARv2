...
# data_loaders related to preindustrial C-cycle
def load_pi(name):
...
# data_loaders related to preindustrial fires
...
# load pre-processed CMIP5 results for specified model
# data_loaders related to C-cycle
...
# load pre-processed CMIP5 results for specified model
# data_loaders related to wildfires
...
# base data_loaders from [Earles et al., 2012]
